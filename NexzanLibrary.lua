--[[
    ╔══════════════════════════════════════════════════════════╗
    ║              NEXZAN LIBRARY v1.0                         ║
    ║         WindUI Modified + Custom Dropdown System         ║
    ║                                                          ║
    ║  Modified Features (Built-in):                           ║
    ║  ✓ Player Dropdown (icon user) - scrollable             ║
    ║  ✓ Settings Dropdown (icon gear) - scrollable           ║
    ║  ✓ Background URL support                               ║
    ║  ✓ Font changer                                         ║
    ║  ✓ UI Size adjuster                                     ║
    ║                                                          ║
    ║  Usage:                                                  ║
    ║  local NexzanLib = loadstring(...)()                    ║
    ║  local Window = NexzanLib:CreateWindow({...})           ║
